...
// ValCursToCurs3 : данная функция записывает данные полученные из архивного xml в структуру cursOfOldDay (при этом берется только 12 валют из 34) для последующей записи в []Curs
